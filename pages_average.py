    ...
    for processo in listaDeProcessos:
        ...
        for arquivo in listaDeArquivos:
            ...
            if not volUnico:
                ...
                #    #os.remove(pathFileProcesso) #não remove pasta com conteúdo
                #    shutil.rmtree(pathFileProcesso)
        ...
        print("o processo possui " + str(pagesTotalperProcess) + " páginas")
